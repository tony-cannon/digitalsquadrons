...
if ( bp_group_is_admin() ) {
    ...
    /**
     * Only allow group admins the option to add events...
     * 
     * TODO: Allow user to select priveleges so other members can submit events...
     */
    if ( bp_group_is_admin() ) { 
        
    ?>
        <a class="tribe-button tribe-button-primary add-new" href="#" data-featherlight="#ds-group-event-form">
