...
if( is_user_logged_in() ) {
		...
		<li id="wp-admin-bar-my-account-xprofile" class="menupop parent">
			...
			<div class="ab-sub-wrapper wrapper">
				<ul id="wp-admin-bar-my-account-xprofile-default" class="ab-submenu">
					...
					<?php } ?>
					<li id="wp-admin-bar-my-account-xprofile-location">
						<a class="ab-item" href="<?php echo trailingslashit( $profile_link . 'member-location' ); ?>"><?php _e( 'Location', 'buddyboss-theme' ); ?></a>
					</li>
					<li id="wp-admin-bar-my-account-xprofile-change-aircraft-platform">
						<a class="ab-item" href="<?php echo trailingslashit( $profile_link . 'platform-aircraft' ); ?>"><?php _e( 'Platforms and Aircraft', 'buddyboss-theme' ); ?></a>
					</li>
					<li id="wp-admin-bar-my-account-xprofile-change-social-media">
						<a class="ab-item" href="<?php echo trailingslashit( $profile_link . 'social-media' ); ?>"><?php _e( 'Social Media', 'buddyboss-theme' ); ?></a>
					</li>
				</ul>
			</div>
		</li>
			...
			<div class="ab-sub-wrapper wrapper">
				<ul id="wp-admin-bar-my-account-settings-default" class="ab-submenu">
                    ...
                    <li id="wp-admin-bar-mp-subscriptions">
                        <a class="ab-item" href="<?php echo trailingslashit( bp_loggedin_user_domain() ) . 'mp-membership/mp-subscriptions/'; ?>">
                            <?php echo _x( 'Subscriptions', 'ui', 'buddyboss-theme' ); ?>
                        </a>
                    </li>
					<li id="wp-admin-bar-my-account-settings-profile">
						<a class="ab-item" href="<?php echo trailingslashit( $settings_link . 'account-admin-visibility-mode' ); ?>">
							<?php _e( 'Profile Visibility', 'buddyboss-theme' ); ?>
						</a>
					</li>
					<li id="wp-admin-bar-mp-invites">
                        <a class="ab-item" href="<?php echo trailingslashit( $settings_link . 'invites' ); ?>">
                            <?php echo _x( 'Squadron Invites', 'ui', 'buddyboss-theme' ); ?>
                        </a>
                    </li>
			...
			<div class="ab-sub-wrapper wrapper">
				<ul id="wp-admin-bar-my-account-groups-default" class="ab-submenu">
					<li id="wp-admin-bar-my-account-groups-memberships">
						<a class="ab-item" href="<?php echo esc_url( $groups_link ); ?>"><?php _e( 'My Squadrons', 'buddyboss-theme' ); ?></a>
					</li>
					...
					<li id="wp-admin-bar-my-account-groups-create">
						<a class="ab-item" href="<?php echo get_site_url( null, 'create-a-squadron' ); ?>"><?php _e( 'Create a Squadron', 'buddyboss-theme' ); ?></a>
					</li>
				</ul>
			</div>
		</li>
    ...
    /**
     * THIS INCLUDED MEMBERPRESS BUT REMOVED FOR MORE CONTROL...
     */
