			...
			<div class="list-wrap">
				...
				<?php if( !bp_disable_group_cover_image_uploads() ) { ?>
					...
					if ( ! $group_cover_image_url ) {
						$group_cover_image_url = $default_group_cover;
						$cover_css = 'ds-default-cover';
					}
					//$group_cover_image_url = $group_cover_image_url ?: $default_group_cover;
					
					?>
					<div class="bs-group-cover only-grid-view"><a href="<?php bp_group_permalink(); ?>"><img src="<?php echo $group_cover_image_url; ?>" class="<?php echo $cover_css; ?><"></a></div>
				<?php } ?>
