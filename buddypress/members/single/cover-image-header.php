...
<?php if ( ! bp_is_user_messages() && ! bp_is_user_settings() && ! bp_is_user_notifications()&& ! bp_is_user_profile_edit() && ! bp_is_user_change_avatar() && ! bp_is_user_change_cover_image() && ! ds_is_user_locations() && ! ds_is_user_platform_aircraft() && ! ds_is_user_social_media() ) : ?>
				...
				<div class="flex">
					<div class="bb-user-content-wrap">
						<div class="flex align-items-center member-title-wrap">
							<h2 class="user-nicename"><a href="#" class="hint--warning" disabled="disabled" data-bp-tooltip-pos="right" data-bp-tooltip="<?php echo ds_members_get_previous_aliases_output( bp_displayed_user_id() ); ?>" data-balloon-break=""><?php echo bp_core_get_user_displayname( bp_displayed_user_id() ); ?></a></h2>
							<?php
