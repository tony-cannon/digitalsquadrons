...
<?php if( bp_is_user_profile_edit() || bp_is_user_change_avatar() || bp_is_user_change_cover_image() || ds_is_user_locations() || ds_is_user_platform_aircraft() || ds_is_user_social_media() ) { ?>
...
<div class="bp-profile-wrapper">
	<?php
	if( bp_is_user_profile_edit() || bp_is_user_change_avatar() || bp_is_user_change_cover_image() || ds_is_user_locations() || ds_is_user_platform_aircraft() || ds_is_user_social_media() ) {
		...
		<div class="profile <?php echo bp_current_action(); ?>">
			...
			switch ( bp_current_action() ) :
                ...
                case 'member-location':
                    bp_get_template_part( 'members/single/profile/member-location');
                    break;

				case 'platform-aircraft':
					bp_get_template_part( 'members/single/profile/platform-aircraft');
					break;

				case 'social-media':
					bp_get_template_part( 'members/single/profile/social-media');
					break;
