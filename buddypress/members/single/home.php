...
if( !bp_is_user_settings() && !bp_is_user_messages() && !bp_is_user_notifications() && !bp_is_user_profile_edit() && !bp_is_user_change_avatar() && !bp_is_user_change_cover_image() && !ds_is_user_locations() && !ds_is_user_platform_aircraft() && !ds_is_user_social_media() ) {
	$grid_class = 'bb-grid';
}

if ( bp_is_user_messages() || bp_is_user_settings() || bp_is_user_notifications() || bp_is_user_profile_edit() || bp_is_user_change_avatar() || bp_is_user_change_cover_image() || ds_is_user_locations() || ds_is_user_platform_aircraft() || ds_is_user_social_media() ) {
...
?>
	...
	<div class="bp-wrap <?php echo $user_full_template; ?>">
		<?php if ( ! bp_nouveau_is_object_nav_in_sidebar() && ! bp_is_user_messages() && ! bp_is_user_settings() && ! bp_is_user_notifications() && ! bp_is_user_profile_edit() && ! bp_is_user_change_avatar() && ! bp_is_user_change_cover_image() && ! ds_is_user_locations() && ! ds_is_user_platform_aircraft() && ! ds_is_user_social_media() ) : ?>
	...
	<?php if ( isset($bp_nouveau_appearance['user_nav_display']) && $bp_nouveau_appearance['user_nav_display'] &&  is_active_sidebar( 'profile' ) && !bp_is_user_settings() && !bp_is_user_messages() && !bp_is_user_notifications() && !bp_is_user_profile_edit() && !bp_is_user_change_avatar() && !bp_is_user_change_cover_image() && !ds_is_user_locations() && !ds_is_user_platform_aircraft() && !ds_is_user_social_media() && !bp_is_user_front() && $profile_cover_width != 'default' ) { ?>
			</div>
