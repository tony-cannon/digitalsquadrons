...
function ds_group_change_status_meta_output( $type, $group ) {
	...
	$term = get_term_by('slug', $groupPlatform, 'ds-software-platform');
...
function ds_get_region_dropdown( $id, $filter = false, $selected = null, $placeHolder = 'All Countries' ) {
	...
	$html = '<select class="ds-country-selector dsCountry' . $id . ' mepr-form-input" id="' . $id . '" name="' . $id . '" ' . $filter . ' required>';
