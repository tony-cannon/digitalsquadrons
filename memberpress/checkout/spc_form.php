...
/**
 * Establish the product we are subscribing too...
 */
...
$productID = esc_attr($product->ID);
$productName = array_search( $productID, $availableProducts );
...
<div class="mp_wrapper">
  <form id="ds-squadron-submit" class="mepr-signup-form mepr-form" method="post" action="<?php echo $_SERVER['REQUEST_URI'].'#mepr_jump'; ?>" enctype="multipart/form-data" novalidate>
