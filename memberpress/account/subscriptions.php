		...
		<table id="mepr-account-subscriptions-table" class="mepr-account-table">
		  ...
		  <tbody>
			...
			foreach($subscriptions as $s):
			  ...
			  /**
			   * Gather Buddypress group details
			   * 
			   * 
			   * 
			   */

				$groupID = $sub->get_meta( '_ds_group_id', true );
			  ...
			  <tr id="mepr-subscription-row-<?php echo $s->id; ?>" class="mepr-subscription-row <?php echo (isset($alt) && !$alt)?'mepr-alt-row':''; ?>">
				<td data-label="<?php _ex('Membership', 'ui', 'buddyboss-theme'); ?>">
				  ...
				  <?php if($is_group_active): ?>
					<div class="mepr-account-group-name"><a href="<?php echo bp_get_group_permalink( $group ); ?>"><?php echo $group->name; ?></a></div>
				  <?php endif; ?>
				</td>
				...
				<td data-label="<?php _ex('Actions', 'ui', 'buddyboss-theme'); ?>">
					...
					<?php if($is_group_active): ?>
						<div class="mepr-group-edit"><a href="<?php echo bp_get_group_permalink( $group ); ?>">Edit Squadron</a></div>
				  	<?php endif; ?>
				</td>
